      ...
      <div className="grilla">
        ...
        <div className='item-detail'>
            ...
            <div className="medios-de-pago">
              ...
              <div className='tipos'>
                <img src="../src/img/medios de pago/visa.png" alt="" />
                <img src="../src/img/medios de pago/MasterCard_Logo.svg.png" alt="" />
                <img src="../src/img/medios de pago/pngwing.com.png" alt="" />
              </div>
            </div>
            <div className='envios'>
              <img src="../src/img/camion-envio.png" alt="" />
              <div className='texto'>
